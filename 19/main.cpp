...
LL calc(unsigned char cr1o, unsigned char cr2o, unsigned char cr3o, unsigned char cr3c, unsigned char cr4o, unsigned char cr4b)
{
    ...
    while(!q.empty())
    {
        ...
        if(rob1 >= 5*rob2 || rob2 >= 5*rob1)continue;
        ...
        if(Mcmo*3 >= res1 && res3 <= cr4b*3){q.push({(unsigned char)(Nres1     ), (unsigned char)(Nres2     ), (unsigned char)(Nres3     ), (unsigned char)(Nres4     ), rob1  , rob2  , rob3  , rob4  , (unsigned char)(time+1)});}
    }
